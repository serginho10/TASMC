	...
	\begin{center}
		\begin{tabular}{|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|}
			...
			\hline 
				...
				\multicolumn{1}{m{2.5cm}|}{\includegraphics[width=25mm, height=25mm]{Figuras/crux.png}} \\
      		\hline \rowcolor[RGB]{240,248,255} 
				...
				\multicolumn{1}{m{2.5cm}|}{\includegraphics[width=25mm, height=25mm]{Figuras/meridian.png}} \\
      		\hline 
		\end{tabular}
	\end{center}
	...
	\begin{center}
		\begin{tabular}{|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|>{\color{blanco}}c|}
			...
			\hline 
				...
				\multicolumn{1}{m{2.5cm}|}{\includegraphics[width=25mm, height=25mm]{Figuras/gateGuru.png}} \\
      		\hline \rowcolor[RGB]{240,248,255} 
				...
				\multicolumn{1}{m{2.5cm}|}{\includegraphics[width=25mm, height=25mm]{Figuras/kayak.png}} \\
      		\hline
				...
				\multicolumn{1}{m{2.5cm}|}{\includegraphics[width=25mm, height=25mm]{Figuras/tripit.png}} \\
      		\hline
			\end{tabular}
	\end{center}
